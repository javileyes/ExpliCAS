...
DEFAULT_DIFF_COMMAND_MATRIX_CASES = (
    ...
    DiffCommandMatrixCase(
        name="ftc_gaussian_upper_bound",
        expr="diff(integrate(e^(t^2), t, 0, x), x)",
        expected_result="e^(x^2)",
        expected_step_substrings=("Calcular la derivada",),
        family="fundamental_theorem_leibniz",
        argument_regime="non_elementary_integrand_variable_upper",
        domain_regime="total_real_function",
        trace_regime="leibniz_variable_bound",
        presentation_regime="integrand_at_upper_bound",
    ),
    DiffCommandMatrixCase(
        name="ftc_fresnel_upper_bound",
        expr="diff(integrate(sin(t^2), t, 0, x), x)",
    ...
    DiffCommandMatrixCase(
        name="ftc_gaussian_chain_rule_square_bound",
        expr="diff(integrate(e^(t^2), t, 0, x^2), x)",
        expected_result="2·x·e^(x^4)",
        expected_step_substrings=("Calcular la derivada",),
        family="fundamental_theorem_leibniz",
        argument_regime="non_elementary_integrand_nonlinear_upper",
        domain_regime="total_real_function",
        trace_regime="leibniz_variable_bound_chain_rule",
        presentation_regime="integrand_times_bound_derivative",
    ),
    DiffCommandMatrixCase(
        name="ftc_sine_integral_si_function",
        expr="diff(integrate(sin(t)/t, t, 1, x), x)",
        expected_result="sin(x) / x",
        expected_required_display=("t ≠ 0", "x ≠ 0"),
        expected_step_substrings=("Calcular la derivada",),
        family="fundamental_theorem_leibniz",
        argument_regime="non_elementary_integrand_pole_condition",
        domain_regime="nonzero_denominator_required",
        trace_regime="leibniz_variable_bound",
        presentation_regime="integrand_at_upper_bound",
    ),
    DiffCommandMatrixCase(
        name="ftc_gaussian_variable_lower_bound_sign_flip",
        expr="diff(integrate(e^(-t^2), t, x, 1), x)",
        expected_result="-1 / e^(x^2)",
        expected_step_substrings=("Calcular la derivada",),
        family="fundamental_theorem_leibniz",
        argument_regime="non_elementary_integrand_variable_lower",
        domain_regime="total_real_function",
        trace_regime="leibniz_variable_bound_lower_sign",
        presentation_regime="negated_integrand_at_lower_bound",
    ),
    DiffCommandMatrixCase(
