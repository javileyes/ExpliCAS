...
class IntegrateCommandMatrixSmokeTests(unittest.TestCase):
    def test_default_matrix_covers_integrate_policy_axes(self) -> None:
        ...
        self.assertEqual(len(cases), 189)
        ...
        self.assertEqual(
            ...
            {"residual": 15, "supported": 169, "undefined": 5},
        )
        self.assertEqual(
            sum(
                1
        ...
        self.assertEqual(
            SMOKE.count_verification_regimes(cases),
            {
                ...
                "definite_ftc_from_verified_antiderivative": 21,
                "verified_by_diff": 30,
        ...
        self.assertEqual(
            SMOKE.count_by(cases, "domain_regime"),
            {
                ...
                "boundary_touch_one_sided_limit": 3,
        ...
        self.assertEqual(
            SMOKE.count_calculus_block_gates(cases),
            {
                ...
                "didactic_trace_and_verified_antiderivative": 48,
                "domain_conditions_and_verified_antiderivative": 101,
