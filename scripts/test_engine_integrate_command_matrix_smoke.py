...
class IntegrateCommandMatrixSmokeTests(unittest.TestCase):
    def test_default_matrix_covers_integrate_policy_axes(self) -> None:
        ...
        self.assertEqual(
            ...
            {"residual": 15, "supported": 160, "undefined": 3},
        )
        self.assertEqual(
            sum(
                1
        ...
        self.assertEqual(
            SMOKE.count_verification_regimes(cases),
            {
                ...
                "definite_ftc_from_verified_antiderivative": 12,
                "verified_by_diff": 30,
                "verified_by_diff_and_direct_diff_integrate": 88,
                "verified_by_direct_diff_integrate": 30,
            },
        )
        self.assertEqual(SMOKE.count_verified_supported_cases(cases), 148)
        self.assertEqual(
    ...
    def test_direct_diff_integrate_coverage_is_visible_by_block_and_cluster(
        ...
        self.assertEqual(len(SMOKE.direct_diff_integrate_exact_cases(cases)), 112)
