...
class IntegrateCommandMatrixSmokeTests(unittest.TestCase):
    def test_default_matrix_covers_integrate_policy_axes(self) -> None:
        ...
        self.assertEqual(len(cases), 306)
        ...
        self.assertEqual(
            ...
            {"residual": 15, "supported": 286, "undefined": 5},
        )
        self.assertEqual(
            sum(
                1
        ...
        self.assertEqual(
            SMOKE.count_verification_regimes(cases),
            {
                ...
                "definite_ftc_from_verified_antiderivative": 46,
                "verification_gap": 32,
                "verified_by_diff": 39,
        ...
        self.assertEqual(SMOKE.count_verified_supported_cases(cases), 208)
        self.assertEqual(
        ...
        self.assertEqual(
            step_checked,
            {
                "odd_power_times_exp_quadratic_substitution",
                "odd_higher_power_times_exp_quadratic_substitution",
                "odd_power_times_sine_quadratic_substitution",
                ...
                "gaussian_full_line",
                "gaussian_second_moment_half_line",
                "gaussian_scaled_decay_half_line",
                "gamma_half_integer_reciprocal_root",
                "gamma_half_integer_root_moment",
                "gamma_half_integer_three_halves_moment",
                "gamma_half_integer_scaled_decay",
                "product_to_sum_sin_cos_distinct_frequencies",
                "product_to_sum_cos_cos_distinct_frequencies",
                "product_to_sum_sin_sin_distinct_frequencies",
                "quintuple_angle_square_power_reduction",
                ...
                "reciprocal_quadratic_irrational_shifted",
                "mixed_trig_odd_cosine_cube",
                "mixed_trig_odd_sine_cube",
                "mixed_trig_quartic_sine_odd_cosine",
                "mixed_trig_quintic_sine_even_cosine",
                "mixed_trig_odd_sine_quartic_cosine",
                "mixed_trig_shared_double_angle",
                "arcsec_reciprocal_hyperbola_radical",
                "arcsec_inverse_square_cofactor",
                "arcsec_circle_radical_over_x",
                "arcsec_circle_radical_over_square",
                "arcsec_log_kernel_positive_shift",
                "arcsec_hyperbola_radical_over_x",
                "weierstrass_shifted_cosine_arctan",
                "weierstrass_shifted_sine_reciprocal",
                "weierstrass_half_angle_tangent",
                "weierstrass_textbook_sine_arctan",
                "weierstrass_sine_over_shifted_sine",
                "weierstrass_double_angle_slope",
                "linear_radical_monomial_cofactor",
                "linear_radical_square_cofactor",
                "linear_radical_scaled_radicand",
                "linear_radical_rationalized_reciprocal",
                "linear_radical_arctan_quotient",
                "linear_radical_three_half_power",
                "exponential_rational_logistic_reciprocal",
                "exponential_rational_arctan_gudermannian",
                "exponential_rational_improper_quotient",
                "exponential_rational_tanh_half_surface",
                "exponential_rational_double_slope_pole",
                "exponential_rational_half_slope_arctan",
                ...
                "definite_integral_odd_symmetry_rational",
                "definite_integral_odd_symmetry_entire",
                ...
                "definite_integral_boundary_convergent_log_square",
                "definite_integral_boundary_convergent_x_log",
                "definite_integral_boundary_convergent_log_over_sqrt",
                "definite_integral_boundary_convergent_x2_log",
                "definite_integral_boundary_convergent_sqrt_x_log",
                ...
                "radical_numerator_unit_circle",
                "radical_numerator_square_cofactor",
                "radical_numerator_hyperbolic_asinh",
                "definite_integral_semicircle_area",
                ...
                "definite_integral_improper_inf_alias_spelling",
                ...
                "linear_times_affine_sine_square_power_reduction",
                "linear_times_quadratic_sine_square_substitution",
                "linear_times_quadratic_cosine_square_substitution",
            },
        )
        ...
        self.assertEqual(
            SMOKE.count_radical_inverse_policy_clusters(cases),
            {
                ...
                "block8_linear_radical_substitution": 6,
                "block8_quadratic_radical_over_monomial": 6,
                "block8_polynomial_over_sqrt_hermite_split": 3,
                "block8_radical_numerator_polynomial": 3,
        ...
        self.assertEqual(
            SMOKE.count_calculus_block_gates(cases),
            {
                ...
                "didactic_trace_and_verified_antiderivative": 97,
    ...
    def test_direct_diff_integrate_coverage_is_visible_by_block_and_cluster(
        ...
        self.assertEqual(
            ...
            {
                "block12_hybrid_algorithmic_backend": 20,
                "block4_base_integration": 20,
                "block5_generalized_substitution": 32,
                "block6_rational_integration": 22,
                "block7_trig_hyperbolic_integration": 37,
                "block8_radical_inverse_families": 38,
            },
        )
        self.assertEqual(
            ...
            {
                "algorithmic_backend_boundary_verified": 20,
                "didactic_trace_and_verified_antiderivative": 58,
                "domain_conditions_and_verified_antiderivative": 91,
            },
        )
        self.assertEqual(
        ...
        self.assertEqual(
            SMOKE.count_direct_diff_integrate_radical_inverse_policy_clusters(cases),
            {
                ...
                "block8_inverse_trig_root_reciprocal": 6,
                "block8_linear_over_sqrt_shifted_quadratic": 2,
                "block8_linear_radical_substitution": 4,
                "block8_quadratic_radical_over_monomial": 3,
                "block8_polynomial_over_sqrt_hermite_split": 2,
                "block8_radical_numerator_polynomial": 2,
                "block8_monomial_over_sqrt_reduction": 4,
            },
        )
        self.assertEqual(
        ...
        self.assertEqual(len(SMOKE.direct_diff_integrate_exact_cases(cases)), 121)
        ...
        self.assertEqual(
            ...
            {
                "block4_base_integration": 7,
                "block5_generalized_substitution": 15,
                "block7_trig_hyperbolic_integration": 5,
                "block8_radical_inverse_families": 21,
            },
        )
        self.assertEqual(
