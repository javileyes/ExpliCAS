...
class IntegrateCommandMatrixSmokeTests(unittest.TestCase):
    def test_default_matrix_covers_integrate_policy_axes(self) -> None:
        ...
        self.assertEqual(len(cases), 307)
        ...
        self.assertEqual(
            ...
            {"residual": 15, "supported": 287, "undefined": 5},
        )
        self.assertEqual(
            sum(
                1
        ...
        self.assertEqual(
            step_checked,
            {
                ...
                "exp_times_sinh_via_exp_lowering",
            },
        )
        ...
        self.assertEqual(
            SMOKE.count_calculus_block_gates(cases),
            {
                ...
                "didactic_trace_and_verified_antiderivative": 98,
