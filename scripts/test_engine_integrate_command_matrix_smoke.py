...
class IntegrateCommandMatrixSmokeTests(unittest.TestCase):
    def test_default_matrix_covers_integrate_policy_axes(self) -> None:
        ...
        self.assertEqual(
            ...
            {"residual": 14, "supported": 140, "undefined": 2},
        )
        self.assertEqual(
            sum(
                1
        ...
        self.assertEqual(
            SMOKE.count_verification_regimes(cases),
            {
                ...
                "verified_by_direct_diff_integrate": 22,
            },
        )
        self.assertEqual(SMOKE.count_verified_supported_cases(cases), 140)
        self.assertEqual(
        ...
        self.assertEqual(
            SMOKE.count_by(cases, "domain_regime"),
            {
                ...
                "backend_verified_unconditional_real": 3,
        ...
        self.assertEqual(
            SMOKE.count_calculus_maturity_blocks(cases),
            {
                ...
                "block12_hybrid_algorithmic_backend": 15,
            },
        )
        self.assertEqual(
            SMOKE.count_calculus_block_gates(cases),
            {
                "algorithmic_backend_boundary_verified": 15,
    ...
    def test_direct_diff_integrate_coverage_is_visible_by_block_and_cluster(
        ...
        self.assertEqual(len(SMOKE.direct_diff_integrate_exact_cases(cases)), 105)
