...
class IntegrateCommandMatrixSmokeTests(unittest.TestCase):
    def test_default_matrix_covers_integrate_policy_axes(self) -> None:
        ...
        self.assertEqual(
            ...
            {"residual": 15, "supported": 243, "undefined": 5},
        )
        self.assertEqual(
            sum(
                1
        ...
        self.assertEqual(SMOKE.count_verified_supported_cases(cases), 190)
        self.assertEqual(
        ...
        self.assertEqual(
            SMOKE.count_calculus_block_gates(cases),
            {
                ...
                "domain_conditions_and_verified_antiderivative": 145,
    ...
    def test_direct_diff_integrate_coverage_is_visible_by_block_and_cluster(
        ...
        self.assertEqual(
            ...
            {
                "algorithmic_backend_boundary_verified": 20,
                "didactic_trace_and_verified_antiderivative": 50,
                "domain_conditions_and_verified_antiderivative": 87,
            },
        )
        self.assertEqual(
        ...
        self.assertEqual(len(SMOKE.direct_diff_integrate_equivalence_cases(cases)), 42)
        self.assertEqual(
        ...
        self.assertEqual(
            SMOKE.count_direct_diff_integrate_gap_calculus_block_gates(cases),
            {
                ...
                "domain_conditions_and_verified_antiderivative": 30,
            },
        )
        self.assertEqual(
