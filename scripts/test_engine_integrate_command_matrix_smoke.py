...
class IntegrateCommandMatrixSmokeTests(unittest.TestCase):
    def test_default_matrix_covers_integrate_policy_axes(self) -> None:
        ...
        self.assertEqual(len(cases), 304)
        ...
        self.assertEqual(
            ...
            {"residual": 15, "supported": 284, "undefined": 5},
        )
        self.assertEqual(
            sum(
                1
        ...
        self.assertEqual(SMOKE.count_verified_supported_cases(cases), 206)
        self.assertEqual(
        ...
        self.assertEqual(
            SMOKE.count_calculus_maturity_blocks(cases),
            {
                ...
                "block5_generalized_substitution": 41,
        ...
        self.assertEqual(
            SMOKE.count_calculus_block_gates(cases),
            {
                ...
                "didactic_trace_and_verified_antiderivative": 95,
    ...
    def test_direct_diff_integrate_coverage_is_visible_by_block_and_cluster(
        ...
        self.assertEqual(
            ...
            {
                "didactic_trace_and_verified_antiderivative": 6,
