...
class LimitCommandMatrixSmokeTests(unittest.TestCase):
    def test_default_matrix_covers_limit_policy_axes(self) -> None:
        ...
        self.assertEqual(len(cases), 209)
        ...
        self.assertIn("infinity_fractional_power_negative_exponent_decays", names)
        self.assertIn("infinity_fractional_power_positive_exponent_diverges", names)
        self.assertIn("infinity_fractional_power_odd_denominator_diverges", names)
        ...
        self.assertIn("infinity_log_exp_sum_dominant_base", names)
        self.assertIn("infinity_log_exp_sum_three_terms", names)
        self.assertIn("finite_general_base_exp_zero_quotient", names)
        self.assertIn("finite_general_base_exp_zero_scaled_quotient", names)
        self.assertIn("finite_general_exp_ratio_log_quotient", names)
        self.assertIn("finite_general_exp_ratio_same_base_rational", names)
        self.assertIn("finite_exp_combination_ratio_of_derivatives", names)
        ...
        self.assertIn("infinity_one_to_infinity_power_e", names)
        self.assertIn("infinity_one_to_infinity_power_scaled", names)
        self.assertIn("infinity_general_base_exponential_growth", names)
        self.assertIn("infinity_inf_to_zero_power_dominant_base", names)
        self.assertIn("infinity_exp_quotient_dominance_diverges", names)
        self.assertIn("infinity_exp_quotient_dominance_finite_ratio", names)
        self.assertIn("infinity_exponential_beats_polynomial", names)
        self.assertIn("infinity_polynomial_over_exponential_decays", names)
        self.assertIn("infinity_polynomial_times_decaying_exponential", names)
        self.assertIn("infinity_radical_conjugate_product_quadratic_decay", names)
        self.assertIn("infinity_cbrt_conjugate_bare_difference_cubic_tail", names)
        self.assertIn("infinity_nth_root_conjugate_fourth_root_tail", names)
        self.assertIn("infinity_nth_root_conjugate_zero_times_infinity_product", names)
        self.assertIn("infinity_cbrt_conjugate_zero_times_infinity_product", names)
        self.assertIn(
            "infinity_radical_conjugate_product_sqrt_factor_root_difference", names
        )
        self.assertIn(
            "infinity_radical_conjugate_product_quadratic_root_difference", names
        )
        self.assertIn("finite_one_to_infinity_power_e_definition", names)
        self.assertIn("finite_one_to_infinity_power_second_order", names)
        self.assertIn("finite_one_sided_zero_base_power_x_to_x", names)
        ...
        self.assertEqual(
            ...
            {"finite": 96, "finite_one_sided": 40, "infinity": 73},
        )
        self.assertEqual(
        ...
        self.assertEqual(
            SMOKE.count_by(cases, "required_condition_regime"),
            {
                ...
                "finite_lhopital_nonzero_point_denominator_domain": 4,
                ...
                "finite_exp_zero_denominator_domain": 8,
                ...
                "finite_radical_difference_denominator_and_radicand_domain": 2,
                ...
                "finite_source_definedness": 15,
                "finite_taylor_quotient_denominator_domain": 3,
