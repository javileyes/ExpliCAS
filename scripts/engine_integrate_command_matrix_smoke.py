...
DEFAULT_INTEGRATE_COMMAND_MATRIX_CASES = (
    ...
    IntegrateCommandMatrixCase(
        name="cosine_of_logarithm_cyclic_by_parts",
        expr="integrate(cos(ln(x)), x)",
        expected_result="1/2·x·(sin(ln(x)) + cos(ln(x)))",
        expected_derivative_result="cos(ln(x))",
        expected_derivative_required_display=("x > 0",),
        direct_diff_integrate_from_derivative=True,
        expected_required_display=("x > 0",),
        expected_step_substrings=("Calcular la integral",),
        family="trig_of_logarithm_cyclic_by_parts",
        argument_regime="linear_logarithm_inner",
        domain_regime="logarithm_positive_argument",
        trace_regime="trig_of_logarithm_substitution",
        presentation_regime="cyclic_trig_logarithm_product",
    ),
    IntegrateCommandMatrixCase(
        name="sine_of_logarithm_cyclic_by_parts",
        expr="integrate(sin(ln(x)), x)",
        expected_result="1/2·x·(sin(ln(x)) - cos(ln(x)))",
        expected_derivative_result="sin(ln(x))",
        expected_derivative_required_display=("x > 0",),
        direct_diff_integrate_from_derivative=True,
        expected_required_display=("x > 0",),
        expected_step_substrings=("Calcular la integral",),
    ...
    IntegrateCommandMatrixCase(
        name="cosine_of_affine_logarithm_cyclic_by_parts",
        expr="integrate(cos(ln(2*x+1)), x)",
        expected_result="1/4·(2·x + 1)·(sin(ln(2·x + 1)) + cos(ln(2·x + 1)))",
        expected_derivative_result="cos(ln(2·x + 1))",
        expected_derivative_required_display=("x > -1/2",),
        direct_diff_integrate_from_derivative=True,
        expected_required_display=("x > -1/2",),
        expected_step_substrings=("Calcular la integral",),
        family="trig_of_logarithm_cyclic_by_parts",
        argument_regime="affine_logarithm_inner",
        domain_regime="logarithm_positive_argument",
        trace_regime="trig_of_logarithm_substitution",
        presentation_regime="cyclic_trig_logarithm_product",
    ),
    ...
    IntegrateCommandMatrixCase(
        ...
        expected_derivative_result="e^(x^2)·x^3",
        direct_diff_integrate_from_derivative=True,
        expected_step_substrings=("Calcular la integral",),
        family="odd_power_quadratic_inner_substitution",
        argument_regime="odd_power_quadratic_inner",
        trace_regime="quadratic_inner_substitution",
        presentation_regime="polynomial_times_quadratic_elementary",
    ),
    IntegrateCommandMatrixCase(
        name="odd_higher_power_times_exp_quadratic_substitution",
        expr="integrate(x^5*exp(x^2), x)",
        expected_result="1/2·e^(x^2)·(x^4 + 2 - 2·x^2)",
        expected_derivative_result="e^(x^2)·x^5",
        direct_diff_integrate_from_derivative=True,
        expected_step_substrings=("Calcular la integral",),
        family="odd_power_quadratic_inner_substitution",
        argument_regime="odd_power_quadratic_inner",
    ...
    IntegrateCommandMatrixCase(
        name="odd_power_times_sine_quadratic_substitution",
        expr="integrate(x^3*sin(x^2), x)",
        expected_result="1/2·(sin(x^2) - cos(x^2)·x^2)",
        expected_derivative_result="sin(x^2)·x^3",
        direct_diff_integrate_from_derivative=True,
        expected_step_substrings=("Calcular la integral",),
        family="odd_power_quadratic_inner_substitution",
        argument_regime="odd_power_quadratic_inner",
    ...
    IntegrateCommandMatrixCase(
        name="linear_times_sine_square_power_reduction",
        expr="integrate(x*sin(x)^2, x)",
        expected_result="1/8·(2·x^2 - cos(2·x) - 2·x·sin(2·x))",
        expected_derivative_equivalent_to="x*sin(x)^2",
        expected_step_substrings=("Calcular la integral",),
        family="polynomial_times_trig_square_power_reduction",
        argument_regime="polynomial_times_trig_square",
        trace_regime="trig_square_power_reduction",
        presentation_regime="polynomial_times_double_angle_trig",
    ),
    IntegrateCommandMatrixCase(
        name="quadratic_times_cosine_square_power_reduction",
        expr="integrate(x^2*cos(x)^2, x)",
        expected_result="1/24·(6·x·cos(2·x) + sin(2·x)·(6·x^2 - 3) + 4·x^3)",
        expected_derivative_equivalent_to="x^2*cos(x)^2",
        expected_step_substrings=("Calcular la integral",),
        family="polynomial_times_trig_square_power_reduction",
        argument_regime="polynomial_times_trig_square",
        trace_regime="trig_square_power_reduction",
    ...
    IntegrateCommandMatrixCase(
        name="linear_times_affine_sine_square_power_reduction",
        expr="integrate(x*sin(2*x)^2, x)",
        expected_result="1/32·(8·x^2 - cos(4·x) - 4·x·sin(4·x))",
        expected_derivative_equivalent_to="x*sin(2*x)^2",
        expected_step_substrings=("Calcular la integral",),
        family="polynomial_times_trig_square_power_reduction",
        argument_regime="polynomial_times_trig_square",
        trace_regime="trig_square_power_reduction",
    ...
    IntegrateCommandMatrixCase(
        name="linear_times_quadratic_sine_square_substitution",
        expr="integrate(x*sin(x^2)^2, x)",
        expected_result="1/8·(2·x^2 - sin(2·x^2))",
        expected_derivative_equivalent_to="x*sin(x^2)^2",
        expected_step_substrings=("Calcular la integral",),
        family="polynomial_times_trig_square_substitution",
        argument_regime="polynomial_times_trig_square_quadratic_inner",
        trace_regime="trig_square_power_reduction_substitution",
        presentation_regime="polynomial_times_double_angle_trig",
    ),
    IntegrateCommandMatrixCase(
        name="linear_times_quadratic_cosine_square_substitution",
        expr="integrate(x*cos(x^2)^2, x)",
        expected_result="1/8·(sin(2·x^2) + 2·x^2)",
        expected_derivative_equivalent_to="x*cos(x^2)^2",
        expected_step_substrings=("Calcular la integral",),
        family="polynomial_times_trig_square_substitution",
        argument_regime="polynomial_times_trig_square_quadratic_inner",
        trace_regime="trig_square_power_reduction_substitution",
    ...
    IntegrateCommandMatrixCase(
        name="definite_integral_abs_linear_symmetric",
        expr="integrate(abs(x), x, -1, 1)",
        expected_result="1",
        expected_step_substrings=("Calcular la integral",),
        family="definite_integral_abs_piecewise",
        argument_regime="abs_linear_numeric_bounds",
        domain_regime="interval_certified_unconditional",
        trace_regime="abs_linear_root_split",
        presentation_regime="exact_rational_value",
    ),
    IntegrateCommandMatrixCase(
        name="definite_integral_abs_linear_scaled_root_inside",
        expr="integrate(abs(2*x-1), x, 0, 1)",
        expected_result="1/2",
        expected_step_substrings=("Calcular la integral",),
        family="definite_integral_abs_piecewise",
        argument_regime="abs_linear_numeric_bounds",
    ...
    IntegrateCommandMatrixCase(
        name="definite_integral_abs_linear_root_outside",
        expr="integrate(abs(x-1), x, 2, 5)",
    ...
    IntegrateCommandMatrixCase(
        name="definite_integral_boundary_convergent_log_square",
        expr="integrate(ln(x)^2, x, 0, 1)",
        expected_result="2",
        expected_required_display=("x > 0",),
        expected_step_substrings=(
            "Hallar la antiderivada",
        ...
        family="definite_integral_ftc",
        argument_regime="boundary_touch_power_log_polynomial",
        domain_regime="boundary_touch_one_sided_limit",
        trace_regime="definite_ftc_boundary_limit",
        presentation_regime="exact_rational_value",
    ),
    IntegrateCommandMatrixCase(
        name="definite_integral_boundary_convergent_x_log",
        expr="integrate(x*ln(x), x, 0, 1)",
        expected_result="-1/4",
        expected_required_display=("x > 0",),
        expected_step_substrings=(
            "Hallar la antiderivada",
    ...
    IntegrateCommandMatrixCase(
        name="definite_integral_boundary_convergent_log_over_sqrt",
        expr="integrate(ln(x)/sqrt(x), x, 0, 1)",
        expected_result="-4",
        expected_required_display=("x > 0",),
        expected_step_substrings=(
            "Hallar la antiderivada",
    ...
    IntegrateCommandMatrixCase(
        name="definite_integral_boundary_convergent_x2_log",
        expr="integrate(x^2*ln(x), x, 0, 1)",
        expected_result="-1/9",
        expected_required_display=("x > 0",),
        expected_step_substrings=(
            "Hallar la antiderivada",
    ...
    IntegrateCommandMatrixCase(
        name="definite_integral_boundary_convergent_sqrt_x_log",
        expr="integrate(sqrt(x)*ln(x), x, 0, 1)",
        expected_result="-4/9",
        expected_required_display=("x > 0",),
        expected_step_substrings=(
            "Hallar la antiderivada",
    ...
    IntegrateCommandMatrixCase(
        name="product_to_sum_sin_cos_distinct_frequencies",
        expr="integrate(sin(3*x)*cos(5*x), x)",
        expected_result="1/16·(4·cos(2·x) - cos(8·x))",
        expected_derivative_equivalent_to="sin(3*x)*cos(5*x)",
        expected_direct_diff_integrate_equivalent_to="sin(3*x)*cos(5*x)",
        expected_direct_diff_integrate_required_display=(),
        expected_derivative_required_display=(),
        expected_required_display=(),
        expected_step_substrings=("ProductToSum",),
        family="product_to_sum_distinct_frequency",
        argument_regime="sine_cosine_distinct_multiple_angles",
        domain_regime="total_real_function",
        trace_regime="werner_product_to_sum",
        presentation_regime="cosine_difference_combination",
    ),
    IntegrateCommandMatrixCase(
        name="product_to_sum_cos_cos_distinct_frequencies",
        expr="integrate(cos(3*x)*cos(5*x), x)",
        expected_result="1/16·(sin(8·x) + 4·sin(2·x))",
        expected_derivative_equivalent_to="cos(3*x)*cos(5*x)",
        expected_direct_diff_integrate_equivalent_to="cos(3*x)*cos(5*x)",
        expected_direct_diff_integrate_required_display=(),
        expected_derivative_required_display=(),
        expected_required_display=(),
        expected_step_substrings=("ProductToSum",),
        family="product_to_sum_distinct_frequency",
        argument_regime="cosine_cosine_distinct_multiple_angles",
        domain_regime="total_real_function",
        trace_regime="werner_product_to_sum",
        presentation_regime="sine_sum_combination",
    ),
    IntegrateCommandMatrixCase(
        name="product_to_sum_sin_sin_distinct_frequencies",
        expr="integrate(sin(3*x)*sin(5*x), x)",
        expected_result="1/16·(4·sin(2·x) - sin(8·x))",
        expected_derivative_equivalent_to="sin(3*x)*sin(5*x)",
        expected_direct_diff_integrate_equivalent_to="sin(3*x)*sin(5*x)",
        expected_direct_diff_integrate_required_display=(),
        expected_derivative_required_display=(),
        expected_required_display=(),
        expected_step_substrings=("ProductToSum",),
        family="product_to_sum_distinct_frequency",
        argument_regime="sine_sine_distinct_multiple_angles",
        domain_regime="total_real_function",
        trace_regime="werner_product_to_sum",
        presentation_regime="sine_difference_combination",
    ),
    IntegrateCommandMatrixCase(
        name="quintuple_angle_square_power_reduction",
        expr="integrate(cos(5*x)^2, x)",
        expected_result="1/20·sin(10·x) + 1/2·x",
        expected_derivative_equivalent_to="cos(5*x)^2",
        expected_direct_diff_integrate_equivalent_to="cos(5*x)^2",
        expected_direct_diff_integrate_required_display=(),
        expected_derivative_required_display=(),
        expected_required_display=(),
        expected_step_substrings=("Calcular la integral",),
        family="multiple_angle_power_reduction",
        argument_regime="quintuple_angle_square",
        domain_regime="total_real_function",
        trace_regime="unexpanded_multiple_angle_power_reduction",
        presentation_regime="double_frequency_plus_linear",
    ),
    IntegrateCommandMatrixCase(
        ...
        argument_regime="standard_gaussian_half_line",
        domain_regime="total_real_function",
        trace_regime="gaussian_moment_table",
        presentation_regime="half_root_pi",
    ),
    IntegrateCommandMatrixCase(
        ...
        expected_step_substrings=("Calcular la integral",),
        family="gaussian_moment_table",
        argument_regime="standard_gaussian_full_line",
        domain_regime="total_real_function",
        trace_regime="gaussian_moment_table",
        presentation_regime="root_pi",
    ),
    IntegrateCommandMatrixCase(
        ...
        expected_step_substrings=("Calcular la integral",),
        family="gaussian_moment_table",
        argument_regime="second_moment_half_line",
        domain_regime="total_real_function",
        trace_regime="gaussian_moment_table",
        presentation_regime="quarter_root_pi",
    ),
    IntegrateCommandMatrixCase(
        ...
        expected_step_substrings=("Calcular la integral",),
        family="gaussian_moment_table",
        argument_regime="scaled_decay_half_line",
        domain_regime="total_real_function",
        trace_regime="gaussian_moment_table",
        presentation_regime="half_root_pi_over_two",
    ),
    IntegrateCommandMatrixCase(
        ...
        argument_regime="gamma_reciprocal_root_half_line",
        domain_regime="total_real_function",
        trace_regime="gamma_half_integer_table",
        presentation_regime="root_pi",
    ),
    IntegrateCommandMatrixCase(
        ...
        expected_step_substrings=("Calcular la integral",),
        family="gamma_half_integer_table",
        argument_regime="gamma_root_moment_half_line",
        domain_regime="total_real_function",
        trace_regime="gamma_half_integer_table",
        presentation_regime="half_root_pi",
    ),
    IntegrateCommandMatrixCase(
        ...
        expected_step_substrings=("Calcular la integral",),
        family="gamma_half_integer_table",
        argument_regime="gamma_three_halves_moment_half_line",
        domain_regime="total_real_function",
        trace_regime="gamma_half_integer_table",
        presentation_regime="three_quarter_root_pi",
    ),
    IntegrateCommandMatrixCase(
        ...
        expected_step_substrings=("Calcular la integral",),
        family="gamma_half_integer_table",
        argument_regime="gamma_scaled_decay_half_line",
        domain_regime="total_real_function",
        trace_regime="gamma_half_integer_table",
        presentation_regime="root_pi_over_two",
    ),
    IntegrateCommandMatrixCase(
