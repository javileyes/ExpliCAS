...
help:
	...
	@echo "  make engine-harness-tests -> Python unit tests for engine improvement harnesses"
...
engine-harness-tests:
	python3 -m unittest scripts/test_engine_improvement_scorecard.py scripts/test_engine_embedded_candidate_smoke.py
...
engine-scorecard-profiled:
	python3 ./scripts/engine_improvement_scorecard.py --profile guardrail --orchestrator-profile
