...
**Severity: honesty-violation (3) + dropped-condition (2). 5 probes (axis solve). — MOSTLY FIXED: inverse-trig out-of-range (commit `b97329291c00b60f8dc673239914c681038f22da`) AND the extraneous-root filter (commit `6461f0c238923bfe6d296b036c2add2571c1ca43`); only the `ln(x)=ln(-x)→ℝ` collapse remains a scoped next step (see Fixes below).**
