...
**Residual del cluster de perf:** solo queda **P13** (`Context::add` camina subárboles para conmutatividad de `Mul`) — toca el core de creación de nodos de cas_ast; requiere sesión dedicada con benchmarking propio.
