...
- **Engine Improvement Scorecard**:
  New unified automation entrypoint at
  ...
  - metamorphic simplification benchmarks in `strict` and `nf-first`
...
- Engine improvement is now documented as a multi-axis problem:
  - rule completeness
  - orchestrator / planner routing quality
  - robustness on complex expressions
  - runtime budget preservation
