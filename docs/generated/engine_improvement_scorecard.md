...
- Generated: 2026-04-30T13:59:18.099533+00:00
- Git branch: main
- Git commit: `5d224d4dd0020d59c21d8d3ffc1ce8af3641f715`
- Profile: `guardrail`
...
| --- | --- | --- | --- |
| `embedded_equivalence_context` | `pass` | 4.26s | passed=1445 failed=0 total=1445 wrappers=7 families=25 avg_case=2.948ms |
| `derive_contract` | `pass` | 4.00s | derived=389 unsupported=0 not_equivalent=1 mean_step_count=1.05 generic_simplify_expected=0 |
...
| `derive_didactic_audit` | `pass` | 16.20s | cases=471 flagged=0 no_web_substeps=0 no_web_steps=0 |
| `simplify_didactic_audit` | `pass` | 0.91s | cases=14 flagged=0 no_wire_substeps=0 missing_math_sides=0 |
| `simplify_strict` | `pass` | 17.02s | closure=100.0% nf=0 (0.0%) proved=16519 (100.0%) numeric=0 inconclusive=0 timeouts=0 |
| `calculus_diff_contract` | `pass` | 0.22s | passed=41 failed=0 |
| `calculus_limit_contract` | `pass` | 8.02s | passed=54 failed=0 |
| `calculus_limit_presimplify_contract` | `pass` | 0.62s | passed=8 failed=0 |
| `calculus_integrate_contract` | `pass` | 0.80s | passed=62 failed=0 |
