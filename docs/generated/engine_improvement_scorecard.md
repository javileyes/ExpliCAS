...
- Generated: 2026-05-03T17:40:49.587923+00:00
- Git branch: main
- Git commit: `f2033dd3d2eaa50048c41581cd00f52787f2ffc3`
- Profile: `guardrail`
...
- Outcomes: derived=389 unsupported=0 not_equivalent=1
...
- Outcomes: cases=471 flagged=0 flagged_rate=0.0%
...
- `diff`: passed=92 failed=0 ignored=0 filtered_out=0
- `limit`: passed=54 failed=0 ignored=0 filtered_out=0
- `limit_presimplify_safe`: passed=8 failed=0 ignored=0 filtered_out=0
- `integrate`: passed=130 failed=0 ignored=0 filtered_out=0
...
| --- | --- | --- | --- |
| `embedded_equivalence_context` | `pass` | 4.53s | passed=1445 failed=0 total=1445 wrappers=7 families=25 avg_case=3.135ms |
| `derive_contract` | `pass` | 3.33s | derived=389 unsupported=0 not_equivalent=1 mean_step_count=1.05 generic_simplify_expected=0 |
| `derive_shadow_pressure` | `pass` | 0.18s | sampled=50 derived=50 unsupported=0 not_equivalent=0 mean_step_count=1.08 generic_simplify_strategy_successes=0 single_step=46 |
| `derive_didactic_audit` | `pass` | 10.68s | cases=471 flagged=0 no_web_substeps=0 no_web_steps=0 |
| `simplify_didactic_audit` | `pass` | 0.11s | cases=14 flagged=0 no_wire_substeps=0 missing_math_sides=0 |
| `simplify_strict` | `pass` | 17.89s | closure=100.0% nf=0 (0.0%) proved=16519 (100.0%) numeric=0 inconclusive=0 timeouts=0 |
| `calculus_diff_contract` | `pass` | 1.70s | passed=92 failed=0 |
| `calculus_limit_contract` | `pass` | 0.31s | passed=54 failed=0 |
| `calculus_limit_presimplify_contract` | `pass` | 0.31s | passed=8 failed=0 |
| `calculus_integrate_contract` | `pass` | 14.33s | passed=130 failed=0 |
