...
- Generated: 2026-05-18T10:03:21.123572+00:00
- Git branch: main
- Git commit: `077e22d7691080fcb33d2e50e1a388d068ef8b0f`
- Profile: `guardrail`
...
| --- | --- | --- | --- |
| `embedded_equivalence_context` | `pass` | 9.28s | passed=1488 failed=0 total=1488 wrappers=7 families=27 avg_case=6.237ms |
| `derive_contract` | `pass` | 5.06s | derived=390 unsupported=0 not_equivalent=1 mean_step_count=1.05 generic_simplify_expected=0 |
| `derive_shadow_pressure` | `pass` | 0.27s | sampled=66 derived=66 unsupported=0 not_equivalent=0 mean_step_count=1.11 generic_simplify_strategy_successes=0 single_step=61 multi_step_ids=5 embedded_families=26/26 |
| `derive_didactic_audit` | `pass` | 28.52s | cases=472 flagged=0 no_web_substeps=0 no_web_steps=0 |
...
| `calculus_diff_contract` | `pass` | 6.26s | passed=205 failed=0 |
| `calculus_limit_contract` | `pass` | 1.07s | passed=75 failed=0 |
| `calculus_limit_presimplify_contract` | `pass` | 0.64s | passed=8 failed=0 |
| `calculus_integrate_contract` | `pass` | 4.08s | passed=316 failed=0 |
