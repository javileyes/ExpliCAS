...
- Generated: 2026-05-01T07:00:16.071821+00:00
- Git branch: main
- Git commit: `0e2137a96e46cb0e4694a3cc013e4a54c459e89b`
- Profile: `guardrail`
...
| --- | --- | --- | --- |
| `embedded_equivalence_context` | `pass` | 4.57s | passed=1445 failed=0 total=1445 wrappers=7 families=25 avg_case=3.163ms |
| `derive_contract` | `pass` | 3.25s | derived=389 unsupported=0 not_equivalent=1 mean_step_count=1.05 generic_simplify_expected=0 |
...
| `derive_didactic_audit` | `pass` | 10.63s | cases=471 flagged=0 no_web_substeps=0 no_web_steps=0 |
| `simplify_didactic_audit` | `pass` | 0.13s | cases=14 flagged=0 no_wire_substeps=0 missing_math_sides=0 |
| `simplify_strict` | `pass` | 17.82s | closure=100.0% nf=0 (0.0%) proved=16519 (100.0%) numeric=0 inconclusive=0 timeouts=0 |
| `calculus_diff_contract` | `pass` | 0.66s | passed=61 failed=0 |
| `calculus_limit_contract` | `pass` | 0.34s | passed=54 failed=0 |
| `calculus_limit_presimplify_contract` | `pass` | 0.32s | passed=8 failed=0 |
| `calculus_integrate_contract` | `pass` | 10.81s | passed=78 failed=0 |
