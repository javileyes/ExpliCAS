...
- Generated: 2026-05-09T07:54:05.711708+00:00
- Git branch: main
- Git commit: `4a31cdb03413c6a25c9d6e972df62f625b6141f6`
- Profile: `guardrail`
...
| --- | --- | --- | --- |
| `embedded_equivalence_context` | `pass` | 5.15s | passed=1445 failed=0 total=1445 wrappers=7 families=25 avg_case=3.564ms |
...
| `derive_didactic_audit` | `pass` | 27.85s | cases=472 flagged=0 no_web_substeps=0 no_web_steps=0 |
| `simplify_didactic_audit` | `pass` | 0.92s | cases=14 flagged=0 no_wire_substeps=0 missing_math_sides=0 |
| `simplify_strict` | `pass` | 18.85s | closure=100.0% nf=0 (0.0%) proved=16519 (100.0%) numeric=0 inconclusive=0 timeouts=0 |
| `calculus_diff_contract` | `pass` | 4.46s | passed=163 failed=0 |
| `calculus_limit_contract` | `pass` | 22.05s | passed=64 failed=0 |
| `calculus_limit_presimplify_contract` | `pass` | 0.65s | passed=8 failed=0 |
| `calculus_integrate_contract` | `pass` | 10.83s | passed=180 failed=0 |
