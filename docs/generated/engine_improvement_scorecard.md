...
- Generated: 2026-04-29T21:21:36.701215+00:00
- Git branch: main
- Git commit: `4694eca7345044a597c004a041e0801eb857d8d1`
- Profile: `guardrail`
...
| --- | --- | --- | --- |
| `embedded_equivalence_context` | `pass` | 4.01s | passed=1445 failed=0 total=1445 wrappers=7 families=25 avg_case=2.775ms |
| `derive_contract` | `pass` | 4.00s | derived=383 unsupported=0 not_equivalent=1 mean_step_count=1.05 generic_simplify_expected=0 |
...
| `derive_didactic_audit` | `pass` | 10.08s | cases=465 flagged=0 no_web_substeps=0 no_web_steps=0 |
| `simplify_didactic_audit` | `pass` | 0.11s | cases=14 flagged=0 no_wire_substeps=0 missing_math_sides=0 |
| `simplify_strict` | `pass` | 16.79s | closure=100.0% nf=0 (0.0%) proved=16518 (100.0%) numeric=0 inconclusive=0 timeouts=0 |
