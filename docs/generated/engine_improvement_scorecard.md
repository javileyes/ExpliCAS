...
- Generated: 2026-05-17T08:02:27.203172+00:00
- Git branch: main
- Git commit: `bb1087f18463c97188dde31040875df0a96ad7c6`
- Profile: `guardrail`
...
| --- | --- | --- | --- |
| `embedded_equivalence_context` | `pass` | 9.17s | passed=1488 failed=0 total=1488 wrappers=7 families=27 avg_case=6.163ms |
| `derive_contract` | `pass` | 3.91s | derived=390 unsupported=0 not_equivalent=1 mean_step_count=1.05 generic_simplify_expected=0 |
| `derive_shadow_pressure` | `pass` | 0.29s | sampled=66 derived=66 unsupported=0 not_equivalent=0 mean_step_count=1.11 generic_simplify_strategy_successes=0 single_step=61 multi_step_ids=5 embedded_families=26/26 |
| `derive_didactic_audit` | `pass` | 12.06s | cases=472 flagged=0 no_web_substeps=0 no_web_steps=0 |
| `simplify_didactic_audit` | `pass` | 0.11s | cases=14 flagged=0 no_wire_substeps=0 missing_math_sides=0 |
| `simplify_strict` | `pass` | 19.68s | closure=100.0% nf=0 (0.0%) proved=16519 (100.0%) numeric=0 inconclusive=0 timeouts=0 |
| `calculus_diff_contract` | `pass` | 6.26s | passed=201 failed=0 |
| `calculus_limit_contract` | `pass` | 0.36s | passed=75 failed=0 |
| `calculus_limit_presimplify_contract` | `pass` | 0.33s | passed=8 failed=0 |
| `calculus_integrate_contract` | `pass` | 3.79s | passed=301 failed=0 |
