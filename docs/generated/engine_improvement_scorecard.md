...
- Generated: 2026-05-15T15:39:35.547623+00:00
- Git branch: main
- Git commit: `92604b523260333ce514edc926e8fb312becb603`
- Profile: `guardrail`
...
| --- | --- | --- | --- |
| `embedded_equivalence_context` | `pass` | 6.62s | passed=1487 failed=0 total=1487 wrappers=7 families=27 avg_case=4.452ms |
| `derive_contract` | `pass` | 3.58s | derived=390 unsupported=0 not_equivalent=1 mean_step_count=1.05 generic_simplify_expected=0 |
| `derive_shadow_pressure` | `pass` | 0.26s | sampled=66 derived=66 unsupported=0 not_equivalent=0 mean_step_count=1.11 generic_simplify_strategy_successes=0 single_step=61 multi_step_ids=5 embedded_families=26/26 |
| `derive_didactic_audit` | `pass` | 14.86s | cases=472 flagged=0 no_web_substeps=0 no_web_steps=0 |
| `simplify_didactic_audit` | `pass` | 0.87s | cases=14 flagged=0 no_wire_substeps=0 missing_math_sides=0 |
| `simplify_strict` | `pass` | 20.15s | closure=100.0% nf=0 (0.0%) proved=16519 (100.0%) numeric=0 inconclusive=0 timeouts=0 |
| `calculus_diff_contract` | `pass` | 4.32s | passed=174 failed=0 |
| `calculus_limit_contract` | `pass` | 0.84s | passed=67 failed=0 |
| `calculus_limit_presimplify_contract` | `pass` | 0.60s | passed=8 failed=0 |
| `calculus_integrate_contract` | `pass` | 6.25s | passed=283 failed=0 |
