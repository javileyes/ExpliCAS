...
- Generated: 2026-05-14T08:19:21.406355+00:00
- Git branch: main
- Git commit: `5eb6fee492a842dcde1a35c34a0a7c03fe1ca14c`
- Profile: `guardrail`
...
- `integrate`: passed=224 failed=0 ignored=1 filtered_out=0
...
| --- | --- | --- | --- |
| `embedded_equivalence_context` | `pass` | 6.99s | passed=1487 failed=0 total=1487 wrappers=7 families=27 avg_case=4.701ms |
...
| `derive_didactic_audit` | `pass` | 28.45s | cases=472 flagged=0 no_web_substeps=0 no_web_steps=0 |
| `simplify_didactic_audit` | `pass` | 0.94s | cases=14 flagged=0 no_wire_substeps=0 missing_math_sides=0 |
| `simplify_strict` | `pass` | 19.30s | closure=100.0% nf=0 (0.0%) proved=16519 (100.0%) numeric=0 inconclusive=0 timeouts=0 |
| `calculus_diff_contract` | `pass` | 4.53s | passed=169 failed=0 |
| `calculus_limit_contract` | `pass` | 0.88s | passed=67 failed=0 |
| `calculus_limit_presimplify_contract` | `pass` | 0.62s | passed=8 failed=0 |
| `calculus_integrate_contract` | `pass` | 5.48s | passed=224 failed=0 |
