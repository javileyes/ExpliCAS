...
- Generated: 2026-05-10T10:09:19.285934+00:00
- Git branch: main
- Git commit: `5fa756c503408d0d1fc43f73e11fe84648a2e1dc`
- Profile: `guardrail`
...
- `integrate`: passed=200 failed=0 ignored=1 filtered_out=0
...
| --- | --- | --- | --- |
| `embedded_equivalence_context` | `pass` | 5.34s | passed=1445 failed=0 total=1445 wrappers=7 families=25 avg_case=3.696ms |
| `derive_contract` | `pass` | 4.81s | derived=390 unsupported=0 not_equivalent=1 mean_step_count=1.05 generic_simplify_expected=0 |
| `derive_shadow_pressure` | `pass` | 0.25s | sampled=65 derived=65 unsupported=0 not_equivalent=0 mean_step_count=1.05 generic_simplify_strategy_successes=0 single_step=61 multi_step_ids=4 embedded_families=25/25 |
| `derive_didactic_audit` | `pass` | 30.37s | cases=472 flagged=0 no_web_substeps=0 no_web_steps=0 |
| `simplify_didactic_audit` | `pass` | 0.97s | cases=14 flagged=0 no_wire_substeps=0 missing_math_sides=0 |
| `simplify_strict` | `pass` | 19.55s | closure=100.0% nf=0 (0.0%) proved=16519 (100.0%) numeric=0 inconclusive=0 timeouts=0 |
| `calculus_diff_contract` | `pass` | 4.62s | passed=164 failed=0 |
| `calculus_limit_contract` | `pass` | 20.49s | passed=64 failed=0 |
| `calculus_limit_presimplify_contract` | `pass` | 0.66s | passed=8 failed=0 |
| `calculus_integrate_contract` | `pass` | 9.03s | passed=200 failed=0 |
