...
- Generated: 2026-05-25T06:25:22.248427+00:00
- Git branch: main
...
- Runtime split: artifacts=0.88s cli=0.81s report=0.00s total=1.70s workers=4
- Runtime family hotspots: artifacts=expand:1.258,rationalize:0.508,solve_prep:0.179,finite_telescoping:0.179,trig_contract:0.169,factor:0.167 cli=expand:1.252,rationalize:0.504,trig_contract:0.163,solve_prep:0.162,factor:0.161,finite_telescoping:0.155
- Runtime case hotspots: artifacts=expand_hyperbolic_product_to_sum_to_cosh_cubic_polynomial_with_passthrough:0.560,expand_hyperbolic_product_to_sum_to_cosh_cubic_polynomial:0.537,rationalize_symbolic_linear_root_alt_var:0.207,rationalize_symbolic_linear_root:0.207,finite_aggregate_sum_of_cubes_symbolic_lower_bound:0.087,factor_geometric_difference_power_6:0.063 cli=expand_hyperbolic_product_to_sum_to_cosh_cubic_polynomial_with_passthrough:0.558,expand_hyperbolic_product_to_sum_to_cosh_cubic_polynomial:0.536,rationalize_symbolic_linear_root:0.207,rationalize_symbolic_linear_root_alt_var:0.206,finite_aggregate_sum_of_cubes_symbolic_lower_bound:0.085,factor_geometric_difference_power_6:0.060
...
- `limit`: passed=150 failed=0 ignored=0 filtered_out=0
...
- `integrate`: passed=338 failed=0 ignored=1 filtered_out=0
...
| --- | --- | --- | --- |
| `embedded_equivalence_context` | `pass` | 10.97s | passed=1488 failed=0 total=1488 wrappers=7 families=27 avg_case=7.372ms |
...
| `derive_didactic_audit` | `pass` | 10.64s | cases=472 flagged=0 no_web_substeps=0 no_web_steps=0 artifacts=0.88s cli=0.81s workers=4 top_artifact_family=expand:1.258 top_cli_family=expand:1.252 |
...
| `calculus_diff_contract` | `pass` | 3.07s | passed=259 failed=0 ignored=1 |
| `calculus_diff_command_matrix_smoke` | `pass` | 0.28s | passed=30 failed=0 total=30 supported=19 residual=5 warning_expected=0 required_display=14 step_checked=26 unchecked_supported_steps=0 families=18 |
| `calculus_limit_contract` | `pass` | 0.51s | passed=150 failed=0 |
| `calculus_limit_presimplify_contract` | `pass` | 0.37s | passed=8 failed=0 |
...
| `calculus_integrate_command_matrix_smoke` | `pass` | 0.47s | passed=26 failed=0 total=26 supported=23 residual=1 warning_expected=0 required_display=13 step_checked=26 unchecked_supported_steps=0 antiderivative_verified=23 families=23 |
...
| `calculus_integrate_contract` | `pass` | 4.49s | passed=338 failed=0 ignored=1 |
