...
#[inline]
#[allow(dead_code)]
pub(crate) fn is_negative_number(ctx: &Context, id: ExprId) -> bool {
...
#[inline]
#[allow(dead_code)]
pub(crate) fn is_positive_integer(ctx: &Context, id: ExprId) -> bool {
...
#[inline]
#[allow(dead_code)]
pub(crate) fn as_frac(ctx: &Context, id: ExprId) -> Option<(ExprId, ExprId)> {
    as_div(ctx, id)
}
...
#[inline]
#[allow(dead_code)]
pub(crate) fn is_frac(ctx: &Context, id: ExprId) -> bool {
