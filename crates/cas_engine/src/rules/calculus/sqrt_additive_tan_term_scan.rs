...
use super::sqrt_additive_result_presentation::reciprocal_sqrt_derivative_term_for_calculus_presentation;

pub(super) struct SqrtAdditiveTanTermScan {
    pub(super) tan_scale: BigRational,
    pub(super) tan_arg: Option<ExprId>,
    pub(super) common_trig_denominator_builtin: Option<BuiltinFn>,
...
pub(super) fn scan_sqrt_additive_tan_terms(
    ctx: &mut Context,
    radicand: ExprId,
    var_name: &str,
) -> Option<SqrtAdditiveTanTermScan> {
