...
use super::presentation_utils::{scaled_sqrt_argument_for_calculus_presentation, squared_expr};
...
pub(super) fn arg_is_proven_outside_open_unit_interval(ctx: &mut Context, arg: ExprId) -> bool {
    let one = ctx.num(1);
