...
impl From<cas_solver_core::solver_options::SolverOptions> for super::SolverOptions {
...
impl From<super::SolverOptions> for cas_solver_core::solver_options::SolverOptions {
    fn from(value: super::SolverOptions) -> Self {
        value.to_core()
    }
}
