...
static SOLVE_DESCRIPTIONS: &[SolveDesc] = &[
    ...
    SolveDesc { template: "Ecuación {0} de {1} del sistema en las incógnitas [{2}]", es: "Ecuación {0} de {1} del sistema en las incógnitas [{2}]", en: "Equation {0} of {1} of the system in the unknowns [{2}]" },
    SolveDesc { template: "Eliminación gaussiana exacta sobre racionales y back-substitución: {0}", es: "Eliminación gaussiana exacta sobre racionales y back-substitución: {0}", en: "Exact Gaussian elimination over the rationals and back-substitution: {0}" },
    SolveDesc { template: "Verificación exacta: sustituir los valores en la ecuación {0}", es: "Verificación exacta: sustituir los valores en la ecuación {0}", en: "Exact verification: substitute the values into equation {0}" },
    ...
    SolveDesc { template: "Resolver por Cramer exacto sobre polinomios en los parámetros: {0}", es: "Resolver por Cramer exacto sobre polinomios en los parámetros: {0}", en: "Solve by exact Cramer over polynomials in the parameters: {0}" },
    ...
    SolveDesc { template: "Back-substitute por raíz y verificar cada par contra AMBAS ecuaciones: {0} pares verificados emitidos", es: "Back-substitute por raíz y verificar cada par contra AMBAS ecuaciones: {0} pares verificados emitidos", en: "Back-substitute per root and verify each pair against BOTH equations: {0} verified pairs emitted" },
    ...
    SolveDesc { template: "Equal tangents: the arguments differ by a multiple of pi", es: "Tangentes iguales: los argumentos difieren en un múltiplo de π", en: "Equal tangents: the arguments differ by a multiple of π" },
    SolveDesc { template: "Sign of a reciprocal: c/g compares to zero as its denominator does", es: "Signo de un recíproco: c/g se compara con cero igual que su denominador", en: "Sign of a reciprocal: c/g compares to zero as its denominator does" },
    ...
    SolveDesc { template: "Invert the trig function on one period", es: "Invertir la función trigonométrica en un periodo", en: "Invert the trig function on one period" },
    SolveDesc { template: "Base window where the relation holds", es: "Ventana base donde se cumple la relación", en: "Base window where the relation holds" },
    SolveDesc { template: "Translate the window by the period (k any integer)", es: "Trasladar la ventana por el periodo (k entero cualquiera)", en: "Translate the window by the period (k any integer)" },
