...
use crate::solve_core::solve_with_ctx_and_options;
use crate::CasError;
    ...
    execute_pow_isolation_with_kernel_config_and_unified_step_mapper_for_var_with_state(
        ...
        |simplifier, tactic_base, tactic_rhs| {
            cas_solver_core::log_domain::classify_log_solve_with_env_and_tri_prover(
                ...
                &ctx.domain_env,
                |core_ctx, expr| {
                    crate::solve::prove_positive_core(core_ctx, expr, opts.value_domain)
                },
            )
        },
        ...
        |core_ctx, assumption| {
            ctx.note_assumption(
                crate::assumption_model::assumption_event_from_log_assumption(
        ...
        |core_ctx, hint| {
            crate::assumption_model::register_log_blocked_hint(core_ctx, hint);
        },
