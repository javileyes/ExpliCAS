...
pub(crate) fn assumption_records_from_eval_output(
...
pub(crate) fn blocked_hints_from_eval_output(
    output: &crate::EvalOutput,
...
pub(crate) fn domain_warnings_from_eval_output(
    output: &crate::EvalOutput,
) -> Vec<crate::DomainWarning> {
...
pub(crate) fn steps_from_eval_output(output: &crate::EvalOutput) -> crate::DisplayEvalSteps {
