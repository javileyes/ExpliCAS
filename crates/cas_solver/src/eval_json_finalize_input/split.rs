use super::types::{EvalJsonFinalizeContext, EvalJsonFinalizeInput, EvalJsonFinalizeShared};

impl<'a> EvalJsonFinalizeInput<'a> {
    pub(crate) fn split(self) -> (EvalJsonFinalizeContext<'a>, EvalJsonFinalizeShared<'a>) {
        (
