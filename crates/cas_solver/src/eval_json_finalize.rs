...
pub(crate) fn finalize_eval_json_output(
    ...
    match result {
        crate::EvalResult::SolutionSet(solution_set) => Ok(finalize_solution_set_output(
            ctx,
            solution_set,
            input,
            input_latex,
        ...
        crate::EvalResult::Bool(b) => Ok(finalize_bool_output(
            *b,
            input,
            input_latex,
            steps_mode,
        ...
        crate::EvalResult::Expr(e) => finalize_expr_like_eval_json_output(
            ctx,
            *e,
            max_chars,
            input,
        ...
        crate::EvalResult::Set(v) if !v.is_empty() => finalize_expr_like_eval_json_output(
            ctx,
            v[0],
            max_chars,
            input,
