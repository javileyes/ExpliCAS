...
use cas_solver::runtime::SolveStep;

// ============================================================================
// Helper functions
// ============================================================================

fn step_descriptions(steps: &[SolveStep]) -> Vec<String> {
...
fn solve_michaelis_menten() -> (SolutionSet, Vec<SolveStep>, Simplifier) {
...
fn solve_ideal_gas_for_t() -> (SolutionSet, Vec<SolveStep>, Simplifier) {
    let mut simplifier = Simplifier::with_default_rules();
    simplifier.set_collect_steps(true);
...
fn solve_combine_like_terms() -> (SolutionSet, Vec<SolveStep>, Simplifier) {
    let mut simplifier = Simplifier::with_default_rules();
    simplifier.set_collect_steps(true);
...
fn solve_fractional_linear() -> (SolutionSet, Vec<SolveStep>, Simplifier) {
    let mut simplifier = Simplifier::with_default_rules();
    simplifier.set_collect_steps(true);
