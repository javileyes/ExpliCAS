...
impl<'a> SemanticEqualityChecker<'a> {
    ...
    /// Delegates to `crate::numeric_eval::as_rational_const`.
    fn try_evaluate_numeric(&self, expr_id: ExprId) -> Option<num_rational::BigRational> {
        crate::numeric_eval::as_rational_const(self.context, expr_id)
    }
    ...
    fn is_negation_of(&self, a: ExprId, b: ExprId) -> bool {
        ...
        if crate::expr_relations::is_negation(self.context, a, b) {
            return true;
        }
