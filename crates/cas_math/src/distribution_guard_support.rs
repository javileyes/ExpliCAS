...
pub(crate) fn should_skip_distribution_for_factor(
    ctx: &Context,
    factor: ExprId,
    additive: ExprId,
) -> bool {
...
pub(crate) fn has_fractional_exponents(ctx: &Context, root: ExprId) -> bool {
...
pub(crate) fn is_binomial_expr(ctx: &Context, expr: ExprId) -> bool {
...
pub(crate) fn should_distribute_factor_over_additive(
    ctx: &Context,
    factor: ExprId,
    additive: ExprId,
    product_expr: ExprId,
...
pub(crate) fn should_block_fractional_coeff_over_binomial(
    ctx: &Context,
...
pub(crate) fn estimate_division_distribution_simplification_reduction(
    ctx: &Context,
