...
pub use didactic::{
    ...
    format_cli_simplification_steps_with_engine, get_standalone_substeps, latex_to_plain_text,
    CliSubstepsRenderPlan, EnrichedStep, SubStep,
};
pub use eval_json_steps::{collect_eval_json_steps, collect_eval_json_steps_with_engine};
pub use timeline::{
    ...
    render_timeline_command_cli_output, render_timeline_command_cli_output_with_engine,
    SolveTimelineHtml, TimelineCliRender, TimelineHtml, VerbosityLevel, TIMELINE_HTML_FILE,
};
