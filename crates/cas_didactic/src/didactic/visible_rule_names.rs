...
pub(crate) fn visible_rule_name(rule_name: &str) -> &str {
    match rule_name {
        ...
        "Reciprocal Cis" => "Invertir la forma cis por su conjugada",
        "Substitute Value" => "Sustituir el valor en la expresión",
...
pub(crate) fn rule_name_es_to_en(es: &str) -> &str {
    match es {
        ...
        "Invertir la forma cis por su conjugada" => "Invert the cis form via its conjugate",
        "Sustituir el valor en la expresión" => "Substitute the value into the expression",
        ...
        "Aplicar composición trigonométrica inversa" => "Apply an inverse trigonometric composition",
        "Aplicar identidad complementaria arcsin/arccos" => "Apply the complementary arcsin/arccos identity",
        "Aplicar identidad de arctangentes" => "Apply the arctangent addition identity",
        "Aplicar identidad de tangente de ángulo mitad" => "Apply the half-angle tangent identity",
        "Aplicar identidad hiperbólica de ángulo mitad" => "Apply the hyperbolic half-angle identity",
        "Aplicar identidad pitagórica" => "Apply the Pythagorean identity",
        "Aplicar identidad pitagórica hiperbólica" => "Apply the hyperbolic Pythagorean identity",
        "Aplicar identidad pitagórica y reagrupar" => "Apply the Pythagorean identity and regroup",
        "Aplicar paridad trigonométrica" => "Apply trigonometric parity",
        "Aplicar suma/diferencia de ángulos" => "Apply the angle sum/difference identity",
        "Cancelar exponencial y logaritmo inversos" => "Cancel inverse exponential and logarithm",
        "Cancelar funciones hiperbólicas inversas" => "Cancel inverse hyperbolic functions",
        "Cancelar logaritmo natural y exponencial inversos" => "Cancel inverse natural logarithm and exponential",
        "Cancelar potencias de la misma base" => "Cancel powers of the same base",
        "Cancelar un cuadrado perfecto con el mismo binomio" => "Cancel a perfect square against the same binomial",
        "Cancelar un factor común" => "Cancel a common factor",
        "Combinar fracciones en una multiplicación" => "Combine fractions in a product",
        "Combinar raíces en un cociente" => "Combine roots in a quotient",
        "Combinar raíces en un producto" => "Combine roots in a product",
        "Conservar límite residual" => "Keep the residual limit",
        "Contraer cuadrado de ángulo doble" => "Contract the squared double angle",
        "Contraer ángulo doble" => "Contract the double angle",
        "Convertir potencia logarítmica inversa" => "Convert an inverse logarithmic power",
        "Convertir un cociente trigonométrico en tangente" => "Convert a trigonometric quotient into a tangent",
        "Evaluar en múltiplo entero de π" => "Evaluate at an integer multiple of pi",
        "Evaluar valor hiperbólico especial" => "Evaluate a special hyperbolic value",
        "Expandir cosecante como recíproco de seno" => "Expand cosecant as the reciprocal of sine",
        "Expandir cotangente como coseno entre seno" => "Expand cotangent as cosine over sine",
        "Expandir identidad de ángulo doble" => "Expand the double-angle identity",
        "Expandir secante como recíproco de coseno" => "Expand secant as the reciprocal of cosine",
        "Factorizar una diferencia de cuadrados y cancelar" => "Factor a difference of squares and cancel",
        "Invertir una resta dentro de una potencia par" => "Flip a subtraction inside an even power",
        "Quitar el valor absoluto de una potencia par" => "Drop the absolute value of an even power",
        "Quitar valor absoluto de una expresión no negativa" => "Drop the absolute value of a non-negative expression",
        "Reconocer un cuadrado perfecto bajo la raíz" => "Recognize a perfect square under the root",
        "Reescribir un exponente negativo" => "Rewrite a negative exponent",
        "Reescribir ángulo quíntuple" => "Rewrite the quintuple angle",
        "Reescribir ángulo triple" => "Rewrite the triple angle",
        "Restar fracciones con mismo denominador" => "Subtract fractions with the same denominator",
        "Simplificar potencia con base negativa" => "Simplify a power with a negative base",
