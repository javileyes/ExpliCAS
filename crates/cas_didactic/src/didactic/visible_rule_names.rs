...
pub(crate) fn rule_name_es_to_en(es: &str) -> &str {
    match es {
        ...
        "Aplicar composición trigonométrica inversa" => {
            "Apply an inverse trigonometric composition"
        }
        "Aplicar identidad complementaria arcsin/arccos" => {
            "Apply the complementary arcsin/arccos identity"
        }
        ...
        "Aplicar identidad hiperbólica de ángulo mitad" => {
            "Apply the hyperbolic half-angle identity"
        }
        ...
        "Cancelar logaritmo natural y exponencial inversos" => {
            "Cancel inverse natural logarithm and exponential"
        }
        "Cancelar potencias de la misma base" => "Cancel powers of the same base",
        "Cancelar un cuadrado perfecto con el mismo binomio" => {
            "Cancel a perfect square against the same binomial"
        }
        ...
        "Convertir un cociente trigonométrico en tangente" => {
            "Convert a trigonometric quotient into a tangent"
        }
        ...
        "Factorizar una diferencia de cuadrados y cancelar" => {
            "Factor a difference of squares and cancel"
        }
        "Invertir una resta dentro de una potencia par" => {
            "Flip a subtraction inside an even power"
        }
        "Quitar el valor absoluto de una potencia par" => {
            "Drop the absolute value of an even power"
        }
        "Quitar valor absoluto de una expresión no negativa" => {
            "Drop the absolute value of a non-negative expression"
        }
        "Reconocer un cuadrado perfecto bajo la raíz" => {
            "Recognize a perfect square under the root"
        }
        ...
        "Cancelar el denominador con todos los términos" => {
            "Cancel the denominator against every term"
        }
