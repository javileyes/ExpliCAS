...
pub(crate) fn derive_isolation_strategy_routing(
    ctx: &Context,
    eq: &Equation,
    var: &str,
...
pub(crate) fn solve_isolation_strategy_routing_with<E, S, FSolve, FMap, FError>(
...
pub(crate) fn derive_collect_terms_kernel(
    ctx: &mut Context,
    eq: &Equation,
    var: &str,
...
pub(crate) fn collect_terms_message(rhs_display: &str) -> String {
...
pub(crate) fn solve_collect_terms_rewrite_pipeline_with_item<E, S, FSolve, FStep>(
...
pub(crate) fn execute_collect_terms_kernel_result_pipeline_for_equation_with_item_with_state<
    T,
    E,
    S,
    FDerive,
...
pub(crate) fn derive_rational_exponent_kernel(
    ctx: &mut Context,
    eq: &Equation,
    var: &str,
    lhs_has_var: bool,
...
/// from `eq` for `var`.
pub(crate) fn derive_rational_exponent_kernel_for_var(
    ctx: &mut Context,
    eq: &Equation,
    var: &str,
) -> Option<RationalExponentKernel> {
...
pub(crate) fn collect_rational_exponent_execution_items(
...
pub(crate) fn build_rational_exponent_execution(
    q: i64,
    lhs_after: ExprId,
    rhs_after: ExprId,
...
pub(crate) fn materialize_rational_exponent_rewrite(
    q: i64,
    lhs_after: ExprId,
    rhs_after: ExprId,
...
#[allow(clippy::too_many_arguments)]
pub(crate) fn execute_rational_exponent_kernel_result_pipeline_with_item_with_state<
    T,
    E,
    S,
    FDerive,
