...
pub(crate) fn map_external_proof_status_with<P, FIsProven, FIsDisproven>(
    proof: P,
    is_proven: FIsProven,
...
pub(crate) fn map_external_nonzero_status_with<P, FIsProven, FIsDisproven>(
    proof: P,
    is_proven: FIsProven,
    is_disproven: FIsDisproven,
) -> NonZeroStatus
...
pub(crate) fn map_tri_proof_status(proof: TriProof) -> ProofStatus {
    match proof {
