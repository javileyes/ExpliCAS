pub(crate) use solve_runtime_flow_preflight_prepare_structural::prepare_equation_for_strategy_with_default_structural_recompose_and_cancel_and_default_residual_acceptance_with_state;
