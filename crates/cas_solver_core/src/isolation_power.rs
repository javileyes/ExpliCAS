    ...
    FSolveRewrite: FnMut(&mut T, &Equation) -> Result<(SolutionSet, Vec<S>), E>,
{
    ...
    execute_pow_isolation_with_default_kernels_for_var_with_state(
        ...
        op,
        var,
        kernel.include_base_item,
        kernel.shortcut_can_branch,
        kernel.log_can_branch,
        kernel.solve_tactic_enabled,
        kernel.mode,
        kernel.wildcard_scope,
        kernel.include_shortcut_item,
        kernel.include_base_one_item,
        kernel.include_terminal_items,
        kernel.include_unsupported_items,
        kernel.include_log_item,
        existing_steps,
        context_ref,
        context_mut,
        render_expr,
