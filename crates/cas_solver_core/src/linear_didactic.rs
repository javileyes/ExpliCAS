...
/// `coef * var = rhs`.
pub(crate) fn linear_collect_factored_message(
    var: &str,
    coeff_display: &str,
    rhs_display: &str,
) -> String {
...
pub(crate) fn linear_collect_divide_message(
    coeff_display: &str,
...
pub(crate) fn linear_collect_collect_message(var: &str) -> String {
    format!("Collect terms in {}", var)
}

/// Build equation `coef * var = rhs`.
pub(crate) fn build_linear_collect_factored_equation(
    ctx: &mut Context,
    var: &str,
    coef: ExprId,
    rhs: ExprId,
...
pub(crate) fn build_linear_collect_additive_equation(
    ctx: &mut Context,
    var: &str,
    coef: ExprId,
    constant: ExprId,
...
pub(crate) fn build_linear_collect_solution_equation(
    ctx: &mut Context,
    var: &str,
    solution: ExprId,
) -> Equation {
...
pub(crate) fn build_linear_collect_factored_step_with<F>(
    ctx: &mut Context,
    var: &str,
    coef: ExprId,
    rhs: ExprId,
...
pub(crate) fn build_linear_collect_additive_step(
    ctx: &mut Context,
    var: &str,
    coef: ExprId,
    constant: ExprId,
...
pub(crate) fn build_linear_collect_divide_step_with<F>(
    ctx: &mut Context,
    var: &str,
    solution: ExprId,
    coef: ExprId,
...
pub(crate) fn build_linear_collect_factored_execution_item_with<F>(
    ctx: &mut Context,
    var: &str,
    coef: ExprId,
    rhs: ExprId,
...
pub(crate) fn build_linear_collect_additive_execution_item(
    ctx: &mut Context,
    var: &str,
    coef: ExprId,
    constant: ExprId,
...
pub(crate) fn build_linear_collect_divide_execution_item_with<F>(
    ctx: &mut Context,
    var: &str,
    solution: ExprId,
    coef: ExprId,
...
pub(crate) fn build_linear_collect_factored_execution_items_with<F>(
    ctx: &mut Context,
    var: &str,
    coef: ExprId,
    rhs: ExprId,
...
pub(crate) fn build_linear_collect_additive_execution_items_with<F>(
    ctx: &mut Context,
    var: &str,
    coef: ExprId,
    constant: ExprId,
