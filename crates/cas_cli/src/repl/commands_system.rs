...
impl Repl {
    ...
    pub(crate) fn handle_solve_system_core(&mut self, line: &str) -> ReplReply {
        let message =
            cas_solver::session_api::algebra::evaluate_linear_system_command_message_on_repl_core(
                &mut self.core,
                line,
            );
...
mod tests {
    ...
    fn evaluate_linear_system_command_message_accepts_parenthesized_form() {
        ...
        let shown = cas_solver::session_api::algebra::evaluate_linear_system_command_message(
            &mut ctx,
