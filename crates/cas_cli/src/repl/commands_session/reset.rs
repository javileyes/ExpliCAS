...
impl Repl {
    ...
    pub(crate) fn handle_reset_command_core(&mut self) -> ReplReply {
        cas_session::repl_api::reset_repl_core_with_config(&mut self.core, &self.config);
    ...
    pub(crate) fn handle_reset_full_command_core(&mut self) -> ReplReply {
        cas_session::repl_api::reset_repl_core_full_with_config(&mut self.core, &self.config);
        reply_output(
