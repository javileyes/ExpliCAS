...
pub(crate) struct EvalCommandEvalView {
    ...
    pub(crate) result: cas_solver::EvalResult,
    pub(crate) diagnostics: cas_solver::Diagnostics,
    pub(crate) steps: cas_solver::DisplayEvalSteps,
    pub(crate) domain_warnings: Vec<cas_solver::DomainWarning>,
    pub(crate) blocked_hints: Vec<cas_solver::BlockedHint>,
}
