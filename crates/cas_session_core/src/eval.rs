...
pub fn is_known_eval_engine_function(name: &str, arity: usize) -> bool {
    ...
    match name {
        ...
        | "catalan" | "bernoulli" | "derangement" | "subfactorial" | "harmonic" | "isperfect"
        | "is_perfect" => arity == 1,
        ...
        "stirling2" | "stirling_second" | "stirling1" | "stirling_first" => arity == 2,
        "gcd" | "lcm" => arity >= 2,
        ...
        "gradient" | "grad" | "jacobian" | "hessian" => arity == 2,
